...
JAZZMIN_SETTINGS={
    "site_title": "Re1gns GMS",
    "site_header": "Reigns GMS Admin",
    "order_with_respect_to": ["auth", "main.banners", "main.services", "main.enquiry", "main.gallery", "main.GalleryImage", "main.page"],
}